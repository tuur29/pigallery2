...
import {setupLightGallery} from './customLightGallery';
...
export class GalleryGridComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy {
  ...
  private useLightGallery = true && !Config.Client.Other.disableLightGallery; // when using lightGallery, make sure you disable the Client.Other.enableOnScrollRendering setting
  private unsupportedExtensions = ['wmv', 'avi', 'mov', 'mpg', 'rn', 'divx']; // will be shown as basic links instead
